...
public class Main {
    public static void main(String[] args) {
        ...
        Wall nortWall = new Wall("North");
        Wall eastWall = new Wall("East");
        Wall westWall = new Wall("West");
        Wall southWall = new Wall("South");
        Wall[]walls = new Wall[] {nortWall, eastWall, westWall, southWall};


        Bedroom bedroom = new Bedroom(nortWall,eastWall, westWall, southWall, ceiling,lamp,
                new Carpet( 2, 3, PaintColor.WHITE),
                "bedroom 1", bed, new Wardrobe(2,2,100));
